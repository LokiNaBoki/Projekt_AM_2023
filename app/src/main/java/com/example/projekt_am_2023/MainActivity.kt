            ...
            Section(
                ...
                mutableListOf(
                    Task(
                        ...
                        "Description of a task 1.1", mutableListOf(), mutableListOf(tag1)
                    ),
                    Task(
                        ...
                        "Description of a task 1.2", mutableListOf(), mutableListOf(tag1, tag2)
                    )
                )
            ),
            Section(
                ...
                mutableListOf(
                    ...
                    Task(
                        ...
                        Calendar.getInstance().apply { time = sdf.parse("2023-04-26 09:05")!! },
                        Calendar.getInstance().apply { time = sdf.parse("2023-04-29 12:20")!! },
                        "Description of a task 2.2", mutableListOf(), mutableListOf(tag1, tag2)
                    ),
                    Task(
                        "Task 2.3", true, user2,
            ...
            Section(
                ...
                mutableListOf(
                    Task(
                        ...
                        "Description of a task 3.1", mutableListOf(), mutableListOf(tag2)
                    ),
                    Task(
                        ...
                        "Description of a task 3.2", mutableListOf(), mutableListOf(tag2)
                    ),
                    Task(
                        ...
                        "Description of a task 3.2", mutableListOf(), mutableListOf(tag1)
                    )
                )
            ),
            Section(
                ...
                mutableListOf(
                    Task(
                        ...
                        "Description of a task 4.1", mutableListOf(), mutableListOf()
                    ),
                    Task(
            ...
            Section(
                ...
                mutableListOf(
                    Task(
                        ...
                        "Description of a task 5.1", mutableListOf(), mutableListOf(tag2)
                    ),
                    Task(
                        ...
                        "Description of a task 5.2", mutableListOf(), mutableListOf(tag1)
                    ),
                    Task(
                        "Task 5.3", false, user2,
                        Calendar.getInstance().apply { time = sdf.parse("2023-09-09 09:09")!! },
                        null,
                        "Description of a task 5.3", mutableListOf(), mutableListOf(tag1)
                    ),
                    Task(
                        "Task 5.4", false, user1,
                        null,
                        Calendar.getInstance().apply { time = sdf.parse("2023-06-06 20:00")!! },
                        "Description of a task 5.4", mutableListOf(), mutableListOf(tag2)
                    ),
                )
            ),
        )
